...
filtered_df_original = df_original[df_original['subject'] == 's020']

# Remove non-resourcful features
filtered_df_original.drop(columns=['subject', 'sessionIndex', 'rep'], inplace=True)
